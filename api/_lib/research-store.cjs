...
const DATA_DICTIONARY = {
  ...
  "fields": [
    ...
    },
    {
      ...
      "type": "UTC ISO-8601",
      "meaning": "Transport receipt timestamp used for UTC outbox partitioning. Later-hour retries may have a new transport timestamp; PostgreSQL retains the first imported event row and receipt date for filtering and exports."
    },
    {
      "name": "qualityFlags",
      "type": "enum array",
