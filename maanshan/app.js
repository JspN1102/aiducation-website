...
function readingToolbar() {
  return '<div class="reader-toolbar"><h2>整首欣賞</h2><div class="reading-toolbar-links"><a class="text-button" href="'+link('explore')+'">'+icon('sparkles')+'走進詩境</a>'+pinyinButton()+'</div></div>';
}
