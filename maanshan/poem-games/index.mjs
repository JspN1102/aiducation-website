...
const loaders={
 ...
 'zeng-wang-lun':()=>import('./zeng.mjs?v=20260920-final5').then(m=>m.mountFarewell),
 'ti-xi-lin-bi':()=>import('./views.mjs?v=20260920a').then(m=>m.mountMountain),
 'bo-chuan-gua-zhou':()=>import('./river.mjs?v=20260920-final5').then(m=>m.mountRiver),
 'gui-yuan-tian-ju':()=>import('./garden.mjs?v=20260920-final5').then(m=>m.mountGarden),
 'zao-chun':()=>import('./rain.mjs?v=20260920-final5').then(m=>m.mountRain)
};
