...
const loaders={
 ...
 'bo-chuan-gua-zhou':()=>import('./river.mjs?v=20260920-art2').then(m=>m.mountRiver),
 'gui-yuan-tian-ju':()=>import('./garden.mjs?v=20260920-art2').then(m=>m.mountGarden),
 'zao-chun':()=>import('./rain.mjs?v=20260920-art2').then(m=>m.mountRain)
};
