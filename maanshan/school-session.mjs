import {TERMS_VERSION, termsConfirmationMarkup, bindTermsConfirmation} from './platform-terms.mjs?v=20260921-school4';
import {mountShishiSprite} from './shishi-sprite.mjs?v=20260921-school4';
