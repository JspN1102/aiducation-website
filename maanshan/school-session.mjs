import {TERMS_VERSION, termsConfirmationMarkup, bindTermsConfirmation} from './platform-terms.mjs?v=20260921-school5';
import {mountShishiSprite} from './shishi-sprite.mjs?v=20260921-school5';
