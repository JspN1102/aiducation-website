...
export const CHALLENGE_SETS = Object.freeze({
  'yong-e': {
    ...
    items: [
      ...
      {id: 'g1-d1', type: 'dictation', prompt: '聽詞語，寫出第一個字。', audio: {text: '白色。請寫出第一個字。', char: '白', pinyin: 'bái'}, target: {char: '白', pinyin: 'bái', accept: ['白']}, explanation: '白色的「白」。詩裏寫的是白色的羽毛。'},
      ...
      {id: 'g1-d2', type: 'dictation', prompt: '聽詞語，寫出第二個字。', audio: {text: '羽毛。請寫出第二個字。', char: '毛', pinyin: 'máo'}, target: {char: '毛', pinyin: 'máo', accept: ['毛']}, explanation: '羽毛的「毛」。最後一筆豎彎鈎，把小尾巴寫出來。'},
  ...
  'zeng-wang-lun': {
    grade: 2,
    title: '桃花潭的來信',
    curriculum: {unit: 2, lesson: 4, focus: 'ua、uo、uai、ui（uei）', sampled: ['ua', 'ui（uei）'], notSampled: ['uo', 'uai'], source: '概覽：二年級第一學段第二單元第四課；教材照片 2-4.3（第27頁）。uai 在詩正文沒有直接例字，補充教學由影片負責。'},
    items: [
      ...
      {id: 'g2-d1', type: 'dictation', prompt: '聽名字，寫出第一個字。', audio: {text: '汪倫。請寫出名字的第一個字。', char: '汪', pinyin: 'wāng'}, target: {char: '汪', pinyin: 'wāng', accept: ['汪']}, explanation: '汪倫的「汪」。左邊是三點水，別和日字旁的「旺」混淆。'},
      ...
      {id: 'g2-d2', type: 'dictation', prompt: '再聽一次名字，寫出第二個字。', audio: {text: '汪倫。請寫出名字的第二個字。', char: '倫', pinyin: 'lún'}, target: {char: '倫', pinyin: 'lún', accept: ['倫', '伦']}, explanation: '汪倫的「倫」，左邊是單人旁；「輪」的部首和意思都不同。'},
  ...
  'ti-xi-lin-bi': {
    ...
    items: [
      ...
      {id: 'g3-d1', type: 'dictation', prompt: '聽詞語，寫出第二個字。', audio: {text: '山嶺。請寫出第二個字。', char: '嶺', pinyin: 'lǐng'}, target: {char: '嶺', pinyin: 'lǐng', accept: ['嶺', '岭']}, explanation: '山嶺的「嶺」，有山字旁。橫着看，山脈綿延，像一道長長的山嶺。'},
      ...
      {id: 'g3-d2', type: 'dictation', prompt: '聽詞語，寫出第一個字。', audio: {text: '側面。請寫出第一個字。', char: '側', pinyin: 'cè'}, target: {char: '側', pinyin: 'cè', accept: ['側', '侧']}, explanation: '側面的「側」，左邊是單人旁。「側看」就是換到側面去看。'},
  ...
  'bo-chuan-gua-zhou': {
    ...
    items: [
      ...
      {id: 'g4-d1', type: 'dictation', prompt: '聽詞語，寫出第二個字。', audio: {text: '新綠。請寫出第二個字。', char: '綠', pinyin: 'lǜ'}, target: {char: '綠', pinyin: 'lǜ', accept: ['綠', '绿']}, explanation: '新綠的「綠」。詩裏把「綠」用作動詞，寫出春風使江岸草木變綠。'},
      ...
      {id: 'g4-d2', type: 'dictation', prompt: '聽詞語，寫出第一個字。', audio: {text: '還鄉。請寫出第一個字。', char: '還', pinyin: 'huán'}, target: {char: '還', pinyin: 'huán', accept: ['還', '还']}, explanation: '還鄉的「還」，意思是回去，讀 huán。詩人盼望回到家鄉。'},
  ...
  'gui-yuan-tian-ju': {
    ...
    items: [
      ...
      {id: 'g5-d1', type: 'dictation', prompt: '聽詞語，寫出第一個字。', audio: {text: '稀疏。請寫出第一個字。', char: '稀', pinyin: 'xī'}, target: {char: '稀', pinyin: 'xī', accept: ['稀']}, explanation: '稀疏的「稀」，左邊是禾字旁。豆苗長得少，不能把它想成茂密的一大片。'},
      ...
      {id: 'g5-d2', type: 'dictation', prompt: '聽農具的名稱，寫出第一個字。', audio: {text: '鋤頭。請寫出第一個字。', char: '鋤', pinyin: 'chú'}, target: {char: '鋤', pinyin: 'chú', accept: ['鋤', '锄']}, explanation: '鋤頭的「鋤」，有金字旁。「帶月荷鋤歸」中的「荷」讀 hè，意思是扛着。'},
  ...
  'zao-chun': {
    ...
    items: [
      ...
      {id: 'g6-d1', type: 'dictation', prompt: '聽詞語，寫出第二個字。', audio: {text: '滋潤。請寫出第二個字。', char: '潤', pinyin: 'rùn'}, target: {char: '潤', pinyin: 'rùn', accept: ['潤', '润']}, explanation: '滋潤的「潤」，左邊是三點水。「潤如酥」寫出細雨柔和、細膩地滋養大地的感覺。'},
      ...
      {id: 'g6-d2', type: 'dictation', prompt: '聽詞語，寫出第一個字。', audio: {text: '遙望。請寫出第一個字。', char: '遙', pinyin: 'yáo'}, target: {char: '遙', pinyin: 'yáo', accept: ['遙', '遥']}, explanation: '遙望的「遙」，有走之旁，表示從遠處看。別與提手旁的「搖」混淆。'},
