...
import {mountChallengeWriting} from './challenge-writing.mjs?v=20260921-school6';
import {mountChallengeModel} from './challenge-model.mjs?v=20260921-school6';
import {mountLivingField} from './living-field.mjs?v=20260921-school6';
...
export function mountChallenge(container, {poem, saved, onChange, onComplete, playAudio, stopAudio, recognize, onResearch = () => {}, onAnswer = () => {}} = {}) {
  ...
  async function loadGame() {
    ...
    try {
      const {mountPoemGame} = await import('./poem-games/index.mjs?v=20260921-school6');
      if (!active()) return;
