...
import {mountChallengeWriting} from './challenge-writing.mjs?v=20260921-school5';
import {mountChallengeModel} from './challenge-model.mjs?v=20260921-school5';
import {mountLivingField} from './living-field.mjs?v=20260921-school5';
...
export function mountChallenge(container, {poem, saved, onChange, onComplete, playAudio, stopAudio, recognize, onResearch = () => {}, onAnswer = () => {}} = {}) {
  ...
  async function loadGame() {
    ...
    try {
      const {mountPoemGame} = await import('./poem-games/index.mjs?v=20260921-school5');
      if (!active()) return;
