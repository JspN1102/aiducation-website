import {initializeSchoolSession, schoolState, onSchoolSessionInvalid} from './school-session.mjs?v=20260922-school13c';
...
schoolSession.then(async school => {
  ...
  try {
    ...
    if (invalidated || schoolState() !== school) return;
    await import('./app.js?v=20260922-school13c');
  } catch {
