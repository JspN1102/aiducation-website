...
def build_image_module(manifest):
    ...
    Keep full-size compatible copies on the same origin. COS remains a backup;
    an unreachable external host must not strand pupils on tiny previews.
    """
    ...
    return ('// Generated by deploy/media_config.py --write. Public teaching images only.\n'
            ...
            '  return COMPAT_IMAGES[path] || IMAGE_ASSETS[path] || source;\n'
            '}\n')
