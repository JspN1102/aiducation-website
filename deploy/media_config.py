...
def build_image_module(manifest):
    ...
    Clients go directly to content-addressed COS objects, avoiding a Vercel
    round trip. Unknown or already-absolute URLs are preserved unchanged.
    """
    images = {asset['source']: asset['destination'] for asset in validated_assets(manifest)
